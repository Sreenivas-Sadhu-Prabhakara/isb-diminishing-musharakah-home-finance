package com.bank.islamic.diminishingmusharakahhomefinance.model;
...
/**
 * The BIAN control record for this service domain: "Diminishing Musharakah Facility Fulfillment Arrangement".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Fulfill) applied
 * to its asset type (Diminishing Musharakah Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Diminishing Musharakah Facility Fulfillment Arrangement";
